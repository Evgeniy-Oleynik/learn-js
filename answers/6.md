...
firstTask().then(valueFromFirstTask => secondTask(valueFromFirstTask)).then(valueFromSecondTask => console.log(valueFromSecondTask));
...
function asyncWrapper (firstTask, secondTask) {
    ...
    f1().then(valueFromFirstTask => f2(valueFromFirstTask)).then(valueFromSecondTask => console.log(valueFromSecondTask));
}
